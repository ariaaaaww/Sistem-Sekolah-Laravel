...
@section('content')
    <main class="mx-auto w-full max-w-2xl flex-1 px-6 py-10">
        ...
        <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
            <div>
                <label for="code" class="mb-1.5 block text-xs font-semibold uppercase tracking-widest text-[#16213A]">
                    Kode Jurusan
                </label>
            ...
            <div>
                ...
                <input type="text" id="name" name="name" placeholder="Nama Jurusan"
                    class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm placeholder:text-slate-400 focus:border-[#A16207] focus:bg-white focus:outline-none">
            </div>
            ...
            <div>
                ...
                <textarea id="description" name="description" placeholder="Penjelasan singkat mengenai jurusan"
