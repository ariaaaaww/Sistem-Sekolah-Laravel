...
<body class="flex min-h-screen items-center justify-center bg-[#F7F6F2] px-6 py-12 text-slate-700">
    ...
    <div class="w-full max-w-md">
        ...
        <form action="{{ route('register-post') }}" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
            ...
            <div>
                <label for="password_confirmation"
                    class="mb-1.5 block text-xs font-semibold uppercase tracking-widest text-[#16213A]">Konfirmasi Kata
                    Sandi</label>
        ...
        <p class="mt-6 text-center text-sm text-slate-500">
            Sudah punya akun?
            <a href="{{ route('login-view') }}" class="font-medium text-[#16213A] hover:text-[#A16207]">Masuk di
                sini</a>
        </p>
